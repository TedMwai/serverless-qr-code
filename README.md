...
``` bash
curl -X GET https://azure-qr-code.azurewebsites.net/api/GenerateQRCode -H "Content-Type: application/json" -d '{"url":"https://www.google.com"}'
```
...
``` bash
git clone https://github.com/TedMwai/serverless-qr-code.git
cd serverless-qr-code/qrCodeGenerator
```
...
`curl -X GET https://<YOUR_FUNCTION_URL>/api/GenerateQRCode -H "Content-Type: application/json" -d '{"url":"https://www.google.com"}'`

## Author

- GitHub: [@tedmwai](https://github.com/TedMwai/serverless-qr-code)